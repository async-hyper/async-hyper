...
from async_hyper_web3 import Reader, Writer
from eth_account.signers.local import LocalAccount
from async_hyper_web3.utils.constants import HL_RPC_URL, HL_TESTNET_RPC_URL
...
from .utils.decorators import private_key_required


class AsyncHyper(BaseAPI):
    address: str
    is_mainnet: bool
    ...
    def _init_evm_client(
        ...
        self.evm_reader = Reader(rpc_url)
        ...
        self.evm_writer = Writer(rpc_url, private_key)
